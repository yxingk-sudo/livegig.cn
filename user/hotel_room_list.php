...
// 生成日期列
$date_columns = [];
if ($project_info && $project_info['start_date'] && $project_info['end_date']) {
    $start_date = new DateTime($project_info['start_date']);
    $end_date = new DateTime($project_info['end_date']);
    ...
    foreach ($period as $date) {
        $date_columns[] = $date->format('Y-m-d');
    }
}
...
<body>
    <div class="table-container">
        ...
        <div class="project-title">
            <?php echo htmlspecialchars($projectName); ?> - 房间表
        </div>
        ...
        <div class="filter-container">
            <form method="GET" id="filterForm" class="d-flex align-items-center gap-3">
                ...
                <div class="filter-buttons">
                    ...
                    <a href="hotel_room_list.php" class="btn btn-outline-secondary filter-btn">
                                ...
                                <table class="table table-striped table-hover table-bordered">
                                    <thead class="table-light">
                                        <tr class="text-center">
                                            ...
                                            <th class="text-center">退房时间</th>
                                            <?php foreach ($date_columns as $date): ?>
                                                <th class="text-center"><?php echo date('m/d', strtotime($date)); ?></th>
                                            <?php endforeach; ?>
                                            <th class="text-center">特殊要求</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                                        ...
                                                        <?php if ($sub_index === 0): ?>
                                                            ...
                                                            <?php foreach ($date_columns as $date): ?>
                                                                <td class="text-center" rowspan="<?php echo $rowspan; ?>">
                                                                    <?php 
                                                                    // 检查这一天是否在入住期间
                                                                    $check_in = new DateTime($room['check_in_date']);
                                                                    $check_out = new DateTime($room['check_out_date']);
                    ...
                    <table class="table table-striped table-bordered daily-room-type-table">
                        ...
                        <tbody>
                            ...
                            <tr class="table-primary">
                                <td class="text-center"><strong>总计</strong></td>
                                <?php 
                                $grand_total = [
                                    'room_count' => 0,
                                    'room_nights' => 0
        ...
        if (document.getElementById('download-img-btn')) {
            document.getElementById('download-img-btn').onclick = function() {
                ...
                html2canvas(exportArea, {
                    ...
                    link.download = '房间表_<?php echo date("Ymd_His"); ?>.png';
        ...
        if (document.getElementById('download-pdf-btn')) {
            document.getElementById('download-pdf-btn').onclick = function() {
                ...
                html2canvas(exportArea, {
                    ...
                    pdf.save('房间表_<?php echo date("Ymd_His"); ?>.pdf');
                });
            };
        }
    });

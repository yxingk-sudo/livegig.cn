...
<head>
    ...
    <!-- 添加 Bootstrap JS 和 Popper.js CDN -->
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    */ ?>
                    ...
                    <!-- 物资管理下拉菜单 -->
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle <?php echo in_array($active_page ?? '', ['add_material', 'materials_all', 'materials_backstage', 'materials_hotel']) ? 'active' : ''; ?>" 
                           href="#" id="materialsDropdown" role="button" data-bs-toggle="dropdown">
                            <i class="bi bi-box-seam"></i> 物资
                        </a>
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item <?php echo ($active_page ?? '') === 'add_material' ? 'active' : ''; ?>" 
                                   href="./add_material.php">
                                    <i class="bi bi-plus-circle"></i> 添加物资
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item <?php echo ($active_page ?? '') === 'materials_all' ? 'active' : ''; ?>" 
                                   href="./materials_all.php">
                                    <i class="bi bi-grid-3x3-gap"></i> 全部物资
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item <?php echo ($active_page ?? '') === 'materials_backstage' ? 'active' : ''; ?>" 
                                   href="./materials_backstage.php">
                                    <i class="bi bi-tv"></i> 后台物资
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item <?php echo ($active_page ?? '') === 'materials_hotel' ? 'active' : ''; ?>" 
                                   href="./materials_hotel.php">
                                    <i class="bi bi-door-open"></i> 酒店物资
                                </a>
                            </li>
                        </ul>
                    </li>

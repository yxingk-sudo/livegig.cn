                                            ...
                                            <div class="border rounded p-3 bg-light">
                                                ...
                                                <p class="mb-1"><strong>角色:</strong> 
                                                    <span class="badge bg-<?php echo $access['role'] === 'admin' ? 'danger' : 'info'; ?>">
                                                        <?php echo $access['role'] === 'admin' ? '管理员' : '普通用户'; ?>
                                                    </span>
                                                </p>
                                                    ...
                                                    <div class="project-card p-3">
                                                        ...
                                                        <div class="mb-0">
                                                            ...
                                                            <select class="form-select form-select-sm" 
                                                                ...
                                                                <option value="user"<?php echo (in_array($project['id'], array_column(array_filter($current_access, function($item) { return $item['role'] === 'user'; }), 'project_id'))) ? ' selected' : ''; ?>>普通用户</option>
                                                                <option value="admin"<?php echo (in_array($project['id'], array_column(array_filter($current_access, function($item) { return $item['role'] === 'admin'; }), 'project_id'))) ? ' selected' : ''; ?>>管理员</option>
                                                            </select>
                                                        </div>
